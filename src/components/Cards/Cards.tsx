...
import InterrogationIcon from "../../assets/svg/interrogation.svg";
import WriteIcon from "../../assets/svg/hand-and-pen.svg";
    ...
    return (
      ...
      <div className="flex flex-wrap justify-center">
        <div onClick={onclickread} className="hover:cursor-pointer bg-white shadow-lg rounded-lg p-6 m-5 w-full sm:w-1/2 lg:w-1/3 flex flex-col items-center justify-center">
          <img className="h-1/4 w-1/4" src={InterrogationIcon} alt="Ícone SVG"/>
        ...
        <img className="h-1/4 w-1/4" src={WriteIcon} alt="Ícone SVG"/>
