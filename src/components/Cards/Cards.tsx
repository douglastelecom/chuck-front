...
export default function Cards({setShowPopup, setPopupDescription}: Card) {
  const onclickread = async () => {
    const x = await getJoke()
    setShowPopup(true)
    setPopupDescription(x)
  }
    return (
      <div className="container mx-auto p-4">
      <div className="flex flex-wrap justify-center">
        <div onClick={onclickread} className="bg-white shadow-lg rounded-lg p-6 m-5 w-full sm:w-1/2 lg:w-1/3 flex flex-col items-center justify-center">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 m-5 w-full sm:w-1/2 lg:w-1/3 flex flex-col items-center justify-center">
